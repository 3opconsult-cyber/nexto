...
LINKS = {c: kit.short(c) for c in [
    ...
    "s1", "s2", "s3", "s4", "sp1", "sp2", "ig2", "igp2", "beta",
]}
...
TARGETS = [
    ...
    ("stickers-contraste.html", "stickers-ping-contraste.pdf", "pdf"),
    ...
    ("ig-carousel-1-particulier.html", "ig_carousel_1_particulier.png", "png1080"),
    ("ig-carousel-2-pro.html",  "ig_carousel_2_pro.png",       "png1080"),
    ("ig-carousel-3-reveal.html", "ig_carousel_3_reveal.png",  "png1080"),
]
