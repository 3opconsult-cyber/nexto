...
export default function BottomTabBar({ onPing }: { onPing?: () => void }) {
  ...
  return (
    <div style={{ position: 'fixed', left: 0, right: 0, bottom: 0, zIndex: 1500, display: 'flex', background: '#fff', borderTop: '1px solid #E7EDEB', paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
